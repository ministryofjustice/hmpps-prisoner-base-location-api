...
class PrisonerBaseLocationIntegrationTest : IntegrationTestBase() {
  ...
  private fun givenKnownPrisoner() = prisonerOffenderSearchMockServer.stubForGet("/prisoner/$knownNomisNumber", readFixtures("prisoneroffendersearch/PrisonerByIdResponse.json"))
